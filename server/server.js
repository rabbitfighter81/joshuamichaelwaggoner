...
fs.readdirSync('./dist/en/').forEach(function (file) {
  if (
    ...
    var result = brotli.compress(fs.readFileSync('./dist/en/' + file), brotliSettings);
...
fs.readdirSync('./dist/es/').forEach(function (file) {
  if (
    ...
    var result = brotli.compress(fs.readFileSync('./dist/es/' + file), brotliSettings);
...
fs.readdirSync('./dist/de/').forEach(function (file) {
  if (
    ...
    var result = brotli.compress(fs.readFileSync('./dist/de/' + file), brotliSettings);
